							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									...
									<div class="doc-info-cont">
										<h4 class="doc-name">Dr. Oscar Dill</h4>
										<!-- <p class="doc-speciality">BDS, MDS - Oral & Maxillofacial Surgery</p> -->
										<p class="doc-department"><img src="@/assets/img/specialities/specialities-05.png" class="img-fluid" alt="Speciality">Physiotherapist</p>
										<div class="rating">
							...
							<div class="tab-content pt-0">
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name">American Accupuncture Medical University</a>
																	<div>BDS</div>
												...
												<div class="experience-box">
													<ul class="experience-list">
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name">Glowing Smiles Family Accupuncture Clinic</a>
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name">Comfort Care Accupuncture Clinic</a>
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<a href="#/" class="name">Dream Smile Accupuncture Practice</a>
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	...
																	<h4 class="exp-title">The Accupuncture Professional of The Year Award</h4>
																	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a ipsum tellus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
																</div>
															</div>
														</li>
								...
								<div role="tabpanel" id="doc_reviews" class="tab-pane fade">
										...
										<ul class="comments-list">
											...
											<li>
												<div class="comment">
													...
													<div class="comment-body">
														<div class="meta-data">
															<span class="comment-author">Avrill Gabriel</span>
												...
												<ul class="comments-reply">
													<li>
														<div class="comment">
															...
															<div class="comment-body">
																<div class="meta-data">
																	<span class="comment-author">Panola Brink</span>
											...
											<li>
												<div class="comment">
													...
													<div class="comment-body">
														<div class="meta-data">
															<span class="comment-author">Denney Rhea</span>
									...
									<div class="write-review">
										<h4>Write a review for <strong>Dr. Oscar Dill</strong></h4>
