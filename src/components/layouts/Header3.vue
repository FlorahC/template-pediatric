    ...
    <top-header></top-header>
        <nav class="navbar navbar-expand-lg header-nav">
                ...
                <ul class="main-nav">
                    ...
                    <li class="has-submenu"  :class="patientsMenu ? 'active' : 'notactive'">
                        ...
                        <ul class="submenu">
                            ...
                            <li :class="currentPath == 'patient-dashboard' || currentPath == 'appointment-detail' ? 'active' : 'notactive'"><router-link to="/patient/index">Patient Dashboard</router-link></li>
                            <li :class="currentPath == 'dependent' || currentPath == 'add-dependent' || currentPath == 'my-doctors' ? 'active' : 'notactive'"><router-link to="/patient/dependent">Patient Dependent</router-link></li>
                            <li :class="currentPath == 'choose-service' ? 'active' : 'notactive'"><router-link to="/patient/choose-service">Choose Service</router-link></li>
                            <li :class="currentPath == 'visit-reason' ? 'active' : 'notactive'"><router-link to="/patient/visit-reason">Visit Reason</router-link></li>
                            <li :class="currentPath == 'visit-question' ? 'active' : 'notactive'"><router-link to="/patient/visit-question">Visit Questionnaire</router-link></li>
                            <li :class="currentPath == 'health-profile' ? 'active' : 'notactive'"><router-link to="/patient/health-profile">Health Profile</router-link></li>
                            <li :class="currentPath == 'find-doctor' ? 'active' : 'notactive'"><router-link to="/patient/find-doctor">Find Doctor</router-link></li>
                            <li :class="currentPath == 'visit-type' ? 'active' : 'notactive'"><router-link to="/patient/visit-type">Visit Type</router-link></li>
                            <li :class="currentPath == 'select-payment' ? 'active' : 'notactive'"><router-link to="/patient/select-payment">Select Payment</router-link></li>
                            <li :class="currentPath == 'visit-confirmed' ? 'active' : 'notactive'"><router-link to="/patient/visit-confirmed">Visit Confirm</router-link></li>
            ...
            <ul class="nav header-navbar-rht">
                <li class="nav-item contact-item"><div class="header-contact-img"></div> <div class="header-contact-detail"></div></li>
...
export default {
        ...
        computed: {
            ...
            doctorMenu() {
                return this.$route.name == 'doctor-index' || this.$route.name == 'doctor-appointments' || this.$route.name == 'schedule-timings' ||  this.$route.name == 'my-patients' ||  this.$route.name == 'messages'  ||  this.$route.name == 'profile-settings' ||  this.$route.name == 'doctor-reviews' ||  this.$route.name == 'doctor-register' ||  this.$route.name == 'doctor-blogs' ||  this.$route.name == 'edit-blog'  ||  this.$route.name == 'add-blog' ||  this.$route.name == 'add-prescription' ||  this.$route.name == 'edit-prescription' ||  this.$route.name == 'add-billing' ||  this.$route.name == 'edit-billing' ||  this.$route.name == 'patient-profile' ;
            },
            patientsMenu() {
                return this.$route.name == 'doctor-mapgrid' || this.$route.name == 'doctor-maplist' || this.$route.name == 'doctor-profile' || this.$route.name == 'search-doctor' ||  this.$route.name == 'booking' ||  this.$route.name == 'booking-success' ||  this.$route.name == 'checkout' ||  this.$route.name == 'patient-dashboard' ||  this.$route.name == 'favourites' ||  this.$route.name == 'chat' ||  this.$route.name == 'patient-profile-settings' ||  this.$route.name == 'patient-change-password' ||  this.$route.name == 'appointment-detail' ||  this.$route.name == 'visit-type' ||  this.$route.name == 'visit-confirmed' ||  this.$route.name == 'visit-question' ||  this.$route.name == 'visit-reason' ||  this.$route.name == 'health-profile' ||  this.$route.name == 'health-profile' ||  this.$route.name == 'select-payment' ||  this.$route.name == 'add-dependent' ||  this.$route.name == 'dependent' ||  this.$route.name == 'my-account' ||  this.$route.name == 'patient-doctor-profile' ||  this.$route.name == 'find-doctor' ||  this.$route.name == 'choose-service' ||  this.$route.name == 'add-dependent' ||  this.$route.name == 'my-doctors';
            },
            pharmacyMenu() {
