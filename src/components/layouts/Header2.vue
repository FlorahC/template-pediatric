            ...
            <div class="main-menu-wrapper">
                ...
                <ul class="main-nav">
                    ...
                    <li class="has-submenu" :class="doctorMenu ? 'active' : 'notactive'">
                        ...
                        <ul class="submenu">
                                <li :class="currentPath == 'doctor-index' || currentPath == 'add-dependent' || currentPath == 'dependent'  || currentPath == 'visit-reason' || currentPath == 'visit-type' || currentPath == 'visit-confirmed' || currentPath == 'health-profile' || currentPath == 'select-payment' || currentPath == 'my-account' || currentPath == 'patient-doctor-profile'  || currentPath == 'find-doctor'  ? 'active' : 'notactive'"><router-link to="/doctor/index">Doctor Dashboard</router-link></li>
                    ...
                    <li class="has-submenu"  :class="patientsMenu ? 'active' : 'notactive'">
                        ...
                        <ul class="submenu" :class="currentPath == 'invoices' || currentPath == 'invoice-view'   ? 'active' : 'notactive'">
                            ...
                            <li :class="currentPath == 'componentss' || currentPath == 'choose-service' ? 'active' : 'notactive'"><router-link to="/components">Components</router-link></li>
...
export default {
        ...
        computed: {
            ...
            pagesMenu() {
                return this.$route.name == 'voice-call' || this.$route.name == 'video-call' || this.$route.name == 'calendar' || this.$route.name == 'componentss' || this.$route.name == 'invoice-view' || this.$route.name == 'logins' || this.$route.name == 'blank' || this.$route.name == 'patient-register' || this.$route.name == 'doctor-register' || this.$route.name == 'invoices' || this.$route.name == 'forgot-password' || this.$route.name == 'choose-service';
            },
            blogMenu() {
