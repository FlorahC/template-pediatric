                                ...
                                <a href="#">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <p class="noti-details"><span class="noti-title">Dr. Lydah Sutton</span> Schedule <span class="noti-title">her appointment</span></p>
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <p class="noti-details"><span class="noti-title">Kacee Butler</span> has booked her appointment to <span class="noti-title">Dr. Orali Fisher</span></p>
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                        <p class="noti-details"><span class="noti-title">Manlio Arnold </span> sent a amount of $210 for his <span class="noti-title">appointment</span></p>
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <p class="noti-details"><span class="noti-title">Saxton Furr</span> send a message <span class="noti-title"> to his doctor</span></p>
