								...
								<div class="doctor-widget">
									<div class="doc-info-left">
										...
										<div class="doc-info-cont">
											...
											<h5 class="doc-department"><img :src="loadImg(item.icon, 2)" class="img-fluid" alt="Speciality">Cardiologist</h5>
											<div class="rating">
...
const userImages = require.context('@/assets/img/patients', false, /\.jpg$/)
